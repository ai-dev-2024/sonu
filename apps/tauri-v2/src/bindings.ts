...
export const commands = {
  ...
  async changeContextAwarenessSetting(
    enabled: boolean,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_context_awareness_setting", {
          enabled,
        }),
      };
    } catch (e) {
  ...
  async setStyleSelection(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("set_style_selection", { category, styleId }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async finishNoteRecording(): Promise<Result<string, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("finish_note_recording"),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async getAvailableOfflineLlmModels(): Promise<
    Result<OfflineLLMModelInfo[], string>
  > {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("get_available_offline_llm_models"),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async getOfflineLlmModelInfo(
    modelId: string,
  ): Promise<Result<OfflineLLMModelInfo | null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("get_offline_llm_model_info", { modelId }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async downloadOfflineLlmModel(
    modelId: string,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("download_offline_llm_model", { modelId }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async deleteOfflineLlmModel(modelId: string): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("delete_offline_llm_model", { modelId }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async cancelOfflineLlmDownload(
    modelId: string,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("cancel_offline_llm_download", { modelId }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async setActiveOfflineLlmModel(
    modelId: string,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("set_active_offline_llm_model", { modelId }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async getCurrentOfflineLlmModel(): Promise<Result<string, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("get_current_offline_llm_model"),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async setOfflinePostProcessEnabled(
    enabled: boolean,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("set_offline_post_process_enabled", {
          enabled,
        }),
      };
    } catch (e) {
  ...
  async getOfflinePostProcessEnabled(): Promise<Result<boolean, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("get_offline_post_process_enabled"),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async hasAnyOfflineLlmModels(): Promise<Result<boolean, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("has_any_offline_llm_models"),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
   ...
   */
  async getCloudTranscriptionStatus(): Promise<
    Result<CloudTranscriptionStatus, string>
  > {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("get_cloud_transcription_status"),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
   ...
   */
  async setCloudTranscriptionEnabled(
    enabled: boolean,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("set_cloud_transcription_enabled", {
          enabled,
        }),
      };
    } catch (e) {
  ...
  async setCloudProvider(providerId: string): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("set_cloud_provider", { providerId }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async setCloudApiKey(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("set_cloud_api_key", { providerId, apiKey }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async setCloudEndpoint(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("set_cloud_endpoint", {
          providerId,
          endpoint,
        }),
      };
  ...
  async setCloudLanguage(language: string): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("set_cloud_language", { language }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
   ...
   */
  async setCloudTranslateToEnglish(
    translate: boolean,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("set_cloud_translate_to_english", {
          translate,
        }),
      };
    } catch (e) {
  ...
  async testCloudConnection(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("test_cloud_connection", {
          providerId,
          apiKey,
          endpoint,
        }),
...
export type AppSettings = {
  ...
  offline_post_process_enabled?: boolean;
  offline_llm_model?: string;
  context_awareness_enabled?: boolean;
  style_selection?: Partial<{ [key in string]: string }>;
  cloud_transcription?: CloudTranscriptionSettings;
};
...
export type CloudTranscriptionProvider = {
  id: string;
  label: string;
  api_endpoint: string;
  allow_endpoint_edit: boolean;
...
export type ModelUnloadTimeout =
  ...
  | "hour_1"
  | "sec_5";
export type OfflineLLMModelInfo = {
  id: string;
  name: string;
  description: string;
  filename: string;
